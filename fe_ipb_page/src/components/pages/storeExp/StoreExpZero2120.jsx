...
//   if (storeProductData.addData <= -1) {
//     console.log("몇개일까?");
//     console.log("몇개일까?",storeProductData.addData.length);
//   }
...
//                         cancelText="아니오"
//                       >
//                         <Button style={{ position: 'static', zIndex: 1 }}>
//                           폐기
//                         </Button>
//                       </Popconfirm>
//                     </td>
...
//   console.log("EXP_Zero: storeProductData", storeProductData);
//   console.log("EXP_Zero: filteredProductData", filteredProductData);
...
//   console.log("EXP_Zero: sortedProducts", sortedProducts);
...
//             {/* {filteredProducts.map((item) => { */}
//             {sortedProducts.map((item) => {
//               if (dupSkuList.includes(item.product_code) && item.addData <= -1) {
//                 return (
//                   <tr key={item.id}>
//                     <td></td>
//                     <td>
    ...
    axios(url_be, {
      ...
      .then((res) => {
        ...
        const addData = res.data.map((item) => ({
          ...item,
          addData: subtractDates(todayDate, item.exp),
        })).filter((item) => item.addData <= -1); // 필터링 조건 추가
